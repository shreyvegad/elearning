    ...
    return (
        <div className='bg-green-100 p-5'>
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 place-content-between">
                ...
                <div className='bg-white rounded-lg relative overflow-hidden bg-no-repeat bg-cover max-w-sm p-3 shadow hover:shadow-lg hover:shadow-green-600/50 hover:rounded-lg mx-auto'>
                    ...
                    <br />
                    <h1 className='font-bold text-4xl'>₹2000<small className='font-normal text-base'>/Year</small></h1>
                    <br />
                    <button onClick={() => { enrolledbtn() }} className='bg-green-600 p-2 sm:m-2 text-white rounded mx-2'>Buy Now</button>
                    <hr />
                    <br />
                ...
                <div className='bg-white rounded-lg relative overflow-hidden bg-no-repeat bg-cover max-w-sm p-3 shadow hover:shadow-lg hover:shadow-green-600/50 hover:rounded-lg mx-auto'>
                    ...
                    <p className='text-gray-500'>All the basics for starting a new course</p>
                    <br />
                    <h1 className='font-bold text-4xl'>₹200<small className='font-normal text-base'>/mo</small></h1>
                    <br />
                    <button onClick={() => { enrolledbtn() }} className='bg-green-600 p-2 sm:m-2 text-white rounded mx-2'>Buy Now</button>
                    <hr />
                    <br />
                ...
                <div className='bg-white rounded-lg relative overflow-hidden bg-no-repeat bg-cover max-w-sm p-3 shadow hover:shadow-lg hover:shadow-green-600/50 hover:rounded-lg mx-auto'>
                    ...
                    <p className='text-gray-500'>All the basics for starting a new course</p>
                    <br />
                    <h1 className='font-bold text-4xl'>₹20<small className='font-normal text-base'>/day</small></h1>
                    <br />
                    <button onClick={() => { enrolledbtn() }} className='bg-green-600 p-2 sm:m-2 text-white rounded mx-2'>Buy Now</button>
                    <hr />
                    <br />
